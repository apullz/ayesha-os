...
╚═══════════════════════════════════════════════╝
  ...
  flora-cli/       [→]  Scottish flora phylo explorer
                         ...
                         └ "ask" command -> qwen2.5:7b

  bring-to-life/   [→]  Image-to-interactive-HTML app
                         └ replaced gemini with ollama 07/2026
                         └ vision -> llama3.2-vision, text -> qwen2.5:7b
  ...
  ! engine: auto-routing defaults to qwen2.5:7b
  ...
  * no personal paths or system info in source
  ...
  ollama pull qwen2.5:7b         # default text model
  ollama pull qwen2.5-coder:14b  # coding (optional)
